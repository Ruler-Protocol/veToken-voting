      ...
      <div className={ theme.palette.type === 'dark' ? classes.containerDark : classes.container }>
        <div className={ classes.copyContainer }>
          <div className={ classes.copyCentered }>
            <Typography variant='h1' className={ classes.chainListSpacing }><span className={ classes.helpingUnderline }>veRuler</span></Typography>
            <Typography variant='h2' className={ classes.helpingParagraph }>Lock RULER to earn protocol fees and emissions and vote on reward gauges</Typography>
          </div>
          <div className={ classes.socials }>
            <a className={ `${classes.socialButton}` } href='https://github.com/Ruler-Protocol/veToken-voting' target='_blank' rel="noopener noreferrer" >
        ...
        <div className={ theme.palette.type === 'dark' ? classes.listContainerDark : classes.listContainer }>
          ...
          </div>
          {
            ...
            <div className={ classes.projectsLoading }>
              <Typography variant='h5' className={ classes.projectsLoadingSpace }>Loading</Typography>
